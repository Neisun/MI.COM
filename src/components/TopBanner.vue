...
export default {
  ...
  data: function data() {
    return {
      ...
      currGoods:[],
      sideItems: [
				{type: 'phones', content: '手机 电话卡',linkUrl:'//www.mi.com/buyphone/'},
				{type: 'computer', content: '笔记本 平板',linkUrl:'//www.mi.com/mibookair/'},
				{type: 'box', content: '电视 盒子',linkUrl:'//www.mi.com/buytv/'},
				{type: 'router', content: '路由器 智能硬件',linkUrl:'//www.mi.com/smart/'},
				{type: 'power', content: '移动电源 电池 插线板',linkUrl:'//list.mi.com/accessories/tag?id=dianyuancunchu'},
				{type: 'headset', content: '耳机 音响',linkUrl:'//list.mi.com/17'},
				{type: 'foil', content: '保护套 贴膜',linkUrl:'//list.mi.com/7'},
				{type: 'line', content: '线材 支架 存储卡',linkUrl:'//list.mi.com/1'},
				{type: 'bags', content: '箱包 服饰',linkUrl:'//list.mi.com/134'},
				{type: 'rabbit', content: '兔米 生活周边',linkUrl:'//list.mi.com/20'}
      ],
      banners: [
				{sourceUrl: 'http://a.union.mi.com/mua?c=17409.0002', imgUrl: '//i3.mifile.cn/a4/xmad_14925951803331_SvsmU.jpg'},
				{sourceUrl: '//item.mi.com/product/10000029.html', imgUrl: '//i3.mifile.cn/a4/xmad_14924228925772_WRpTQ.jpg'},
				{sourceUrl: '//www.mi.com/buytv/', imgUrl: '//i3.mifile.cn/a4/xmad_14917471739205_EgXRY.jpg'},
				{sourceUrl: '//item.mi.com/product/10000032.html', imgUrl: '//i3.mifile.cn/a4/xmad_14924956330586_bdlYL.jpg'},
				{sourceUrl: '//item.mi.com/buyphone/mi5s', imgUrl: '//i3.mifile.cn/a4/xmad_14889651711436_BTJYG.jpg'}
			],
      phones: [
