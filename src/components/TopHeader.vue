<template>
  <div id="top-header">
    <div class="container">
        ...
        <ul class="navs">
            <li v-for="item in navs">
              <template v-if="item.type">
                <a href="javascript:void(0)" class="nav-item" @mouseenter="evtHeaderEnter(item.type)"
      ...
      <div class="header-search">
        <form class="search-form" action="" method="">
          <input type="text" name="" value="" class="search-text" :class="{active:keyWordStatus}" @focus="evtInpFocus" @blur="evtInpBlur">
          ...
          <div class="keyword-list" v-show="keyWordStatus">
            <ul class="result-list">
              <a href="#" v-for="item in keyWordLists">
                <li class="list-item">
    ...
    <transition name="fade">
      <div class="header-menu" v-show="headerStatus" @mouseenter="evtHeaderEnter()"
      @mouseleave="evtHeaderLeave()">
  ...
  data: function data() {
    return {
      ...
      xiaomi: [
			...
			router: [
				{name: '小米路由器 HD', imgUrl: '//c1.mifile.cn/f/i/g/2015/cn-index/lyqhd.png 2x', sourcePath: '//www.mi.com/miwifihd/', price: '1299元'},
				{name: '小米路由器 Pro', imgUrl: '//c1.mifile.cn/f/i/g/2015/cn-index/pro320x220.png 2x', sourcePath: '//www.mi.com/miwifihd/', price: '499元'},
				{name: '小米路由器 3', imgUrl: '//c1.mifile.cn/f/i/g/2015/cn-index/lyq31.png 2x', sourcePath: '//www.mi.com/miwifi3/', price: '149元'},
				{name: '小米路由器 3C', imgUrl: '//c1.mifile.cn/f/i/g/2015/cn-index/lyq3c1.png 2x', sourcePath: '//www.mi.com/miwifi3c/', price: '99元'},
				{name: '小米WiFi电力猫', imgUrl: '//c1.mifile.cn/f/i/g/2015/cn-index/dlm01.png 2x', sourcePath: '//www.mi.com/plc/', price: '249元'},
				{name: '小米WiFi放大器 2', imgUrl: '//c1.mifile.cn/f/i/g/2015/cn-index/fdq2!160x110.jpg', sourcePath: '//item.mi.com/1164700010.html', price: '49元'}
			],
			hardware: [
  ...
  methods: {
    evtInpFocus: function () {
      ...
      this.$http({
        ...
        console.log(res);
        this.keyWordLists = res.data.results;
      }).catch((err) => {
        console.log(err);
      })
    },
