...
export default {
  ...
  data: function data() {
    return {
      promoList:[
        {sourceUrl:'http://1.hd.mi.com/',imgUrl:'//i3.mifile.cn/a4/xmad_1487844180216_JVvCK.jpg'},
        {sourceUrl:'//item.mi.com/buyphone/redmi4x',imgUrl:'//i3.mifile.cn/a4/xmad_14893930547143_gxyTV.jpg'},
        {sourceUrl:'//www.mi.com/mitv3s/48/',imgUrl:'//i3.mifile.cn/a4/xmad_1492396565228_dHUtY.jpg'}
      ]
    }
  }
}
